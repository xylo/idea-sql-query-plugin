...
public class HelpAction extends AnAction
{
	...
	public HelpAction(String topic)
	{
		super("Help");
		this.topic=topic;
		getTemplatePresentation().setIcon(IconManager.getIcon(Icons.HELP));
		getTemplatePresentation().setDescription("Help about using the plugin.");
	}
