 ...
 */
public class StatementTemplateImpl extends XMLAdapter implements StatementTemplate
{
	private String name;
	private String text;

	public StatementTemplateImpl(String name, String text)
	{
		this.name=name;
		this.text=text;
	}
	...
	public StatementTemplateImpl(XMLContext context, String name)
	{
		super(context, name);
	}
	...
	public void setXMLAttribute(XMLContext context, String name, String value)
	{
		...
		else if ("value".equalsIgnoreCase(name)) this.text=value;
	}
}
