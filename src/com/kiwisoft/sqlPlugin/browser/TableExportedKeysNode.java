...
import com.kiwisoft.db.ExportedKey;
 ...
 */
public class TableExportedKeysNode extends DynamicTreeNode
{
	 ...
	 */
	public TableExportedKeysNode(Project project, DatabaseTable table, DefaultTreeModel aTreeModel)
	{
	 ...
	 */
	private void insertKey(ExportedKey key)
	{
		int size=0;
	...
	protected void loadChildren()
	{
		try
		{
			Iterator it=getTable().getExportedKeys(project).iterator();
			while (it.hasNext()) insertKey((ExportedKey)it.next());
		}
		catch (Exception e)
		{
			e.printStackTrace();
