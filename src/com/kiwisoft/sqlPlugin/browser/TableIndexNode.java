 ...
 */
public class TableIndexNode extends DynamicTreeNode
{
	/**
	 * Creates a new tree node.
	 */
	public TableIndexNode(Index index, DefaultTreeModel aTreeModel)
	{
		super(index, aTreeModel);
	}
	...
	public String getText()
	{
		...
		if (StringUtils.isEmpty(name)) name="<"+index.getTypeString()+">";
		return name;
	}
