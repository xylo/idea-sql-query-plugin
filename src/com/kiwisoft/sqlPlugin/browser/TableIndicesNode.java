 ...
 */
public class TableIndicesNode extends DynamicTreeNode
{
     ...
     */
    public TableIndicesNode(Project project, DatabaseTable table, DefaultTreeModel aTreeModel)
    {
    ...
    private void insertIndex(Index index)
    {
        ...
        insert(new TableIndexNode(index, treeModel), size);
    }
    ...
    protected void loadChildren()
    {
        try
        {
            Iterator it=getTable().getIndices(project).iterator();
            while (it.hasNext()) insertIndex((Index) it.next());
        }
        catch (Exception e)
        {
