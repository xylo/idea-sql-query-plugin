 ...
 */
public class ProcedureNode extends DynamicTreeNode
{
     ...
     */
    public ProcedureNode(Project project, StoredProcedure procedure, DefaultTreeModel aTreeModel)
    {
	...
	protected void loadChildren()
	{
		try
		{
			insertNode(new ProcedureParametersNode(project, getProcedure(), treeModel));
		}
		catch (Exception e)
		{
    ...
    {
        return IconManager.getIcon(Icons.PROCEDURE);
    }
}
