 ...
 */
public class DataDirectSQLServerDriver extends SQLServerDriver
{
    public DataDirectSQLServerDriver()
    {
		super("com.ddtek.jdbc.sqlserver.SQLServerDriver");
    }

    public String getId()
    {
        return "jdbc:datadirect:sqlserver";
    }

    public String getName()
    {
        return "SQLServer (DataDirect)";
    }

    public String buildURL(DriverProperties map)
    {
        StringBuffer url=new StringBuffer("jdbc:datadirect:sqlserver://");
